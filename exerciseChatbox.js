      ...
      "https://openrouter.ai/api/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `ang sagot ay tagalog lamang, 5 suggestion kasama ang benepisyong ng workout preformat answer at suggest ng best workout base sa location nato ito 
`,
            },
            {
              role: "user",
